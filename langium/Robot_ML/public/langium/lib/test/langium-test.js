...
export function parseHelper(services) {
    ...
    return async (input, options) => {
        ...
        const uri = URI.parse((_a = options === null || options === void 0 ? void 0 : options.documentUri) !== null && _a !== void 0 ? _a : `file:///${randomNumber}${metaData.fileExtensions[0]}`);
...
export async function parseDocument(services, input) {
...
export function validationHelper(services) {
    ...
    return async (input) => {
        ...
        return { document, diagnostics: (_a = document.diagnostics) !== null && _a !== void 0 ? _a : [] };
    };
}
...
export function clearDocuments(services) {
